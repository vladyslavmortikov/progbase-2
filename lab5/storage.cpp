...
vector<Lection> Storage::getAllLections()
{
    return this->lections_;
}

optional<Lection> Storage::getLectionById(int lection_id)
{
    for (Lection &lec : this->lections_)
    {
...
bool Storage::updateLection(const Lection &lection)
{
...
bool Storage::removeLection(int lection_id)
{
    for (int i = 0; i < lections_.size(); i++)
    {
...
int Storage::insertLection(const Lection &lection)
{
    Lection lec = lection;
...
vector<Topic> Storage::getAllTopics()
{
    return this->topics_;
}

optional<Topic> Storage::getTopicById(int lection_id)
{
    for (Topic &top : this->topics_)
    {
...
bool Storage::updateTopic(const Topic &topic)
{
...
bool Storage::removeTopic(int topic_id)
{
    for (int i = 0; i < topics_.size(); i++)
    {
...
int Storage::insertTopic(const Topic &topic)
{
    Topic top = topic;
